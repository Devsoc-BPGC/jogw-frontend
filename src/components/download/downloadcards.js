...
import { Data } from '../download/download';
import { Data1 } from '../download/download';
...
export default function DownloadCards({ text, index, fix, setGet, setload }) {
